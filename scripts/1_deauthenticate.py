"""
Titre: 1_deauthenticate
Sujet: HEIGVD-SWI23-Labo1-MAC-Sec
Description: 
    Permet de générer et envoyer des trames de déauthentification. Le script
    donne le choix entre des Reason codes différents déduit si le message doit
    être envoyé à la STA ou à l'AP
Auteurs:
    - Anthony Coke
    - Guilain Mbayo
    - Mehdi Salhi
